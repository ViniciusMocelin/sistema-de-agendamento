#!/usr/bin/env python3
"""
Script para criar superuser localmente (desenvolvimento)
...
# Configurar Django para desenvolvimento
...
def create_superuser():
    ...
    print("🔐 Criando superuser localmente...")
...
def main():
    ...
    print("🔐 CRIAÇÃO DE SUPERUSER LOCAL")
    print("=" * 50)
    print()
    ...
    if not verify_database_connection():
        ...
        print("Verifique se:")
        print("  - O banco SQLite está acessível")
        print("  - As migrações foram executadas")
        sys.exit(1)
